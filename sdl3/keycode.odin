...
Keycode :: enum u32 {
	...
	WAKE                 = auto_cast (Scancode.WAKE | SCANCODE_MASK),
	CHANNEL_INCREMENT    = auto_cast (Scancode.CHANNEL_INCREMENT | SCANCODE_MASK),
	CHANNEL_DECREMENT    = auto_cast (Scancode.CHANNEL_DECREMENT | SCANCODE_MASK),
	MEDIA_PLAY           = auto_cast (Scancode.MEDIA_PLAY | SCANCODE_MASK),
	MEDIA_PAUSE          = auto_cast (Scancode.MEDIA_PAUSE | SCANCODE_MASK),
	MEDIA_RECORD         = auto_cast (Scancode.MEDIA_RECORD | SCANCODE_MASK),
	MEDIA_FAST_FORWARD   = auto_cast (Scancode.MEDIA_FAST_FORWARD | SCANCODE_MASK),
	MEDIA_REWIND         = auto_cast (Scancode.MEDIA_REWIND | SCANCODE_MASK),
	MEDIA_NEXT_TRACK     = auto_cast (Scancode.MEDIA_NEXT_TRACK | SCANCODE_MASK),
	MEDIA_PREVIOUS_TRACK = auto_cast (Scancode.MEDIA_PREVIOUS_TRACK | SCANCODE_MASK),
	MEDIA_STOP           = auto_cast (Scancode.MEDIA_STOP | SCANCODE_MASK),
	MEDIA_EJECT          = auto_cast (Scancode.MEDIA_EJECT | SCANCODE_MASK),
	MEDIA_PLAY_PAUSE     = auto_cast (Scancode.MEDIA_PLAY_PAUSE | SCANCODE_MASK),
	MEDIA_SELECT         = auto_cast (Scancode.MEDIA_SELECT | SCANCODE_MASK),
	AC_NEW               = auto_cast (Scancode.AC_NEW | SCANCODE_MASK),
	AC_OPEN              = auto_cast (Scancode.AC_OPEN | SCANCODE_MASK),
	AC_CLOSE = auto_cast (Scancode.AC_CLOSE | SCANCODE_MASK),
	AC_EXIT = auto_cast(Scancode.AC_EXIT | SCANCODE_MASK),
	AC_SAVE = auto_cast(Scancode.AC_SAVE | SCANCODE_MASK),
	AC_PRINT = auto_cast(Scancode.AC_PRINT | SCANCODE_MASK),
	AC_PROPERTIES = auto_cast(Scancode.AC_PROPERTIES | SCANCODE_MASK),
	...
	SOFT_LEFT = auto_cast(Scancode.SOFT_LEFT | SCANCODE_MASK),
	SOFT_RIGHT = auto_cast(Scancode.SOFT_RIGHT | SCANCODE_MASK),
